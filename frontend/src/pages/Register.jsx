...
const Register = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/3 w-96 h-96 bg-accent-500/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-primary-500/20 rounded-full blur-[120px] pointer-events-none" />

      <div className="w-full max-w-md z-10">
        <div className="glass-card p-8 sm:p-10">
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-accent-500 to-primary-500 p-0.5 shadow-xl shadow-accent-500/20 mx-auto mb-4 flex items-center justify-center">
              <div className="w-full h-full bg-dark-900 rounded-[14px] flex items-center justify-center">
                <Cpu className="w-8 h-8 text-accent-500 animate-pulse-slow" />
              </div>
            </div>
            <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
              Intern Registration
            </h2>
            <p className="text-sm text-slate-400 mt-1">Create your account to submit and monitor background AI jobs</p>
          </div>
            ...
            >
              {isSubmitting ? (
                <>
                  ...
                  <span>Creating Intern Account...</span>
                </>
              ) : (
                <>
